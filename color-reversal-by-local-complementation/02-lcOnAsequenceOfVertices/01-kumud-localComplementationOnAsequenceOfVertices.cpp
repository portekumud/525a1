...
void f06_drawGraph(vector<vector<int>>, vector<int>, string, string, string);
...
int main(int argc, char **argv) {
	...
	for(unsigned int i = 0; i < a.length(); i++) {
		cout << endl;
		cout << "iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii: " << i << endl;
...
void f06_drawGraph(vector<vector<int>> myGraph, vector<int> myBicoloration, string nameIndex, string nameTitle, string zeroToT1) {
	vector<vector<int>>::iterator p1_myGraph;
